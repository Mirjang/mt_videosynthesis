...
python sanity_check.py --niter 20000 --niter_decay 10000  --max_clip_length 2 --train_from_video --dataroot $DATASETS_DIR/$DATASET --name sanity_check --model $MODEL --dataset_mode dummy --gpu_ids $GPU_ID --lr $LR --display_port $VISDOM_PORT
