...
class NeuralFaceRendererModel(BaseModel):
    def name(self):
        return 'NeuralFaceRendererModel'
    ...
    def initialize(self, opt):
        ...
        self.visual_names = ['input_uv','background', 'texture_col', 'sampled_texture_col', 'fake', 'target']
        ...
        # texture
        if opt.hierarchicalTex:
            self.texture = define_HierarchicalTexture(opt.nObjects, opt.tex_features, opt.tex_dim, device=self.device, gpu_ids=self.gpu_ids)
        else:
    ...
    def set_input(self, input):
        ...
        self.expressions = input['expressions']
